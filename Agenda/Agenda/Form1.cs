...
namespace addressbook
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Cadastro;Integrated Security=True");
        SqlCommand cmd;
        ...
        private void button1_Click(object sender, EventArgs e) {
            ...
            if (ID >= 0) {
                ...
                try {
                    ...
                    cmd = new SqlCommand("SELECT * FROM Contatos WHERE id=@id", con);
                    con.Open();
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader()) {
                        reader.Read();
                        retorno = "Informações: \n";
                        retorno += "Id: " + reader["id"] + "\n";
                        retorno += "Nome: " + reader["nome"] + "\n";
                        retorno += "Endereço: " + reader["endereco"] + "\n";
                        retorno += "Celular: " + reader["celular"] + "\n";
                        retorno += "Telefone: " + reader["telefone"] + "\n";
                        retorno += "E-mail: " + reader["email"] + "\n";
                    }
